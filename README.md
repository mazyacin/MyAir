...
1. **ESP32 Sensor Node**:
   ...
   - Sends all this data **wirelessly** via **BLE (Bluetooth Low Energy)**.
   - If MQ135 readings exceed a critical threshold, the ESP32 turns ON the **Buzzer** and **Red LED** as an instant local alert.

2. **Flutter Mobile App**:
   - Scans for and connects to the ESP32 over BLE.
   - Displays real-time Temperature, Humidity, and Air Quality on a beautiful dashboard.
   - No internet required – works offline via direct Bluetooth connection.
...
| Power | USB-C cable / Battery pack | 1 |
| Connecting Wires | Jumper wires (Male-to-male)

**Wiring diagram is shown above in the preview section.**

---

## ⚙️ Firmware (ESP32 Code)
...
3. Open the `.ino` file located in `/hardware and esp32`.
4. Flash the code to your ESP32.
5. Once flashed, the ESP32 will advertise as **"MyAir_ESP32"** over BLE.

---

## 🛠️ How to Run the Flutter App (from Source)

If you want to modify the app (iOS or Android):
